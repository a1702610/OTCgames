...
function BlankAnswerInput({ initialAnswers, onCommit, label }) {
  ...
  return (
    <div style={{ marginBottom: 12 }}>
      <label style={{ fontSize: 13, fontWeight: 700, color: 'rgba(20,15,80,0.60)', display: 'block', marginBottom: 5 }}>
        {label} <span style={{ fontWeight: 400, color: 'rgba(20,15,80,0.35)' }}>(comma-separated, case-insensitive)</span>
      </label>
      <input
        type="text"
        value={text}
        ...
        style={{ width: '100%', padding: '8px 12px', borderRadius: 8, border: '1.5px solid rgba(20,15,80,0.14)', fontSize: 14, boxSizing: 'border-box', background: 'rgba(20,15,80,0.05)', color: '#140F50' }}
      />
    </div>
  )
}
...
export function FillInBlanksEditor({ question, onUpdate, onDelete }) {
  ...
  return (
    <div style={{ padding: 18, background: 'rgba(255,255,255,0.78)', border: '1px solid rgba(131,107,255,0.20)', borderRadius: 12, backdropFilter: 'blur(20px)' }}>
      ...
      <label style={{ fontSize: 13, fontWeight: 700, color: 'rgba(20,15,80,0.60)', display: 'block', marginBottom: 6 }}>
        Sentence <span style={{ fontWeight: 400, color: 'rgba(20,15,80,0.35)' }}>(use _ for each blank)</span>
      </label>
      <textarea
        ...
        rows={3}
        style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1.5px solid rgba(20,15,80,0.14)', fontSize: 15, resize: 'vertical', boxSizing: 'border-box', marginBottom: 4, background: 'rgba(20,15,80,0.05)', color: '#140F50' }}
      />
      <p style={{ margin: '0 0 16px', fontSize: 12, color: 'rgba(20,15,80,0.35)' }}>
      ...
      <label style={{ fontSize: 13, fontWeight: 700, color: 'rgba(20,15,80,0.60)', display: 'block', marginBottom: 6, marginTop: blankCount > 0 ? 4 : 0 }}>Explanation</label>
      <textarea
